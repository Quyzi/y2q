...
pub enum Event {
    ...
    RemoteFetched { alias: String, path: RemoteFetchPath, result: RemoteFetchResult },
    /// Progress update for an in-flight transfer.
    TransferUpdate { id: u64, bytes_done: u64, speed_bps: u64 },
    /// Transfer completed (ok = bytes, err = message).
    TransferDone { id: u64, result: Result<u64, String> },
...
pub enum RemoteFetchPath {
    Buckets,
    Objects { bucket: String, prefix: Option<String> },
}
