...
pub use data::{
    ...
    DataError, DescribePlan, DistributedStorage, LabelMode, MigrateReport, MutateMeta, MutateOp,
    MutateResp, PendingWrites, PrepareMeta, PrepareResp, ReadConsistency, ReadPlan, VersionResp,
    resolve_route,
};
